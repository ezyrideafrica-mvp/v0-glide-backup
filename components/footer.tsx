        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <Image src="/logo.png" alt="Glide Network" width={128} height={64} className="h-16 w-32" />
            </div>
            <p className="text-sm text-foreground/70 mb-4">
              Your one stop to all services. Fast, reliable, and professional.
            </p>
            <a
              href="https://instagram.com/glidenetwork"
              target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services" className="text-sm text-foreground/70 hover:text-primary">
                  Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/market" className="text-sm text-foreground/70 hover:text-primary">
                  Market Runs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:info@glidenetwork.biz" className="text-sm text-foreground/70 hover:text-primary">
                  info@glidenetwork.biz
                </a>
              </li>
              <li>
                <a href="tel:+2347015471676" className="text-sm text-foreground/70 hover:text-primary">
                  +234 (701) 547 1676
                </a>
              </li>
              <li>
