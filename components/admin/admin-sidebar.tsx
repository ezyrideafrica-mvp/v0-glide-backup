...
import { LayoutDashboard, Users, ShoppingBag, FileText, Settings, LogOut, Truck, UserCheck } from "lucide-react"
...
const menuItems = [
  ...
  { href: "/admin/providers", label: "Service Providers", icon: UserCheck },
